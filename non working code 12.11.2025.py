...
def check_serial_num(): 
    plane_serial_num = input('Please enter the plane reference number (12 digits): ')
    while not plane_serial_num.isdigit():
        plane_serial_num = ("Please enter the serial number in the format 000000000000 ")
...
def record_job_reason():
        ...
        while flag:
            ...
            try:
                ...
                if local_choice < 1 or local_choice > 6: 
                    print("Sorry, you did not choose an option within the given range")
                    flag = True
                else:
                    job_reason = int(reason_choice)
                    flag = False
...
while not engineer_name.isalpha():
    engineer_name = input('Please enter your name using only letters: ')
